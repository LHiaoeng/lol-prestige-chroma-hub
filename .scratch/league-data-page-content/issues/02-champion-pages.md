...
**What to build:** 让现有中英文英雄目录展示名称、头像和定位，并让英雄详情展示英雄名称及该英雄去重后的统一皮肤资料项（顶层皮肤与任务阶段）的名称、缩略图和本地化稀有度。
...
- [x] 自动化测试覆盖目录字段、筛选、英雄详情不显示默认外观和完成状态、统一皮肤集合去重、tier 展开与 ID 冲突优先级、缩略图、阶段详情、稀有度、链接参数、本地化隔离和禁止的额外字段。
