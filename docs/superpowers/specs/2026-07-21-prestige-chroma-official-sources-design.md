# Prestige Chroma Official Sources Design

## Goal

Add verified first-party sources to the bilingual prestige-chroma guide so acquisition and cultural claims are directly supported without turning the article into a detached bibliography.
...
- Use descriptive anchor text rather than bare URLs.
- Mark each link as `Official source` or `官方来源` in visible copy.
- Open external sources in a new tab with `target="_blank"` and `rel="noreferrer"`.
- Do not claim that an example activity represents a permanent acquisition method; event rules, reward pools, and dates remain specific to each linked page.

## Verified Sources

- `https://lol.qq.com/act/a202607034771tendraws31/index.html` — 璀璨臻彩召唤, Tencent-CP.
- `https://lol.qq.com/act/a202606264151prizewheel/index.html` — 幸运之门, Tencent-CP.
