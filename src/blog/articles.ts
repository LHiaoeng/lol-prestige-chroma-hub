...
export const blogArticles: readonly BlogArticle[] = [
  {
    ...
    summaryEn: 'The Brilliant Prestige Chroma Summoning event runs September 17 – October 18, 2026 on the Chinese server. Dumpling Darlings Syndra (Pearl) and Faerie Court Ezreal (Rose Quartz) headline the self-select prize pools, the Dark Star Diana prestige skin joins the grand-prize tier, and the first summon costs 12 RMB.',
    summaryZh: '2026 年 9 月 17 日至 10 月 18 日，新一期璀璨臻彩召唤上线：特等奖自选点心宝贝 辛德拉 芥菜点心或至臻皮肤 暗星女王 黛安娜，一等奖自选花仙贵族 伊泽瑞尔 玫瑰水晶眼，首次召唤 12 元。',
    publishedAt: '2026-09-17',
    readingMinutes: 4,
    coverUrl: 'https://img.chromaart.lol/chromas/6c5d5c56-66af-4744-988c-6ebe19092c66/site3.jpg',
    coverAltEn: 'Dumpling Darlings Syndra (Pearl) prestige chroma splash art — Brilliant Prestige Chroma Summoning Session 202621 grand prize',
    coverAltZh: '点心宝贝 辛德拉 芥菜点心臻彩原画 — 璀璨臻彩召唤第 202621 期特等奖',
  ...
  },
  {
    ...
    summaryEn: 'The Lucky Gate: Ocean Song summoning event runs September 13 – October 11, 2026 on the Chinese server. Ocean Song Soraka (Pearl), Ocean Song Jinx (Pearl), and Ocean Song Yone (Tanzanite) prestige chromas join the wheel, plus the mythic Admiral Battle Bunny Miss Fortune skin.',
    summaryZh: '2026 年 9 月 13 日至 10 月 11 日，幸运之门·海之歌召唤活动上线。海之歌 索拉卡 拾音、海之歌 金克丝 燥音两款珍珠白钻石臻彩与海之歌 永恩 幻彩夜空臻彩加入奖池，另有神话皮肤幻灵战斗兔司令 厄运小姐。',
    publishedAt: '2026-09-13',
    readingMinutes: 3,
    coverUrl: 'https://img.chromaart.lol/chromas/d3bf92b5-7e37-4f09-815b-df86b34bc3bd/site3.jpg',
    coverAltEn: 'Ocean Song Yone (Tanzanite) prestige chroma splash art — Lucky Gate Ocean Song event',
    coverAltZh: '海之歌 永恩 幻彩夜空臻彩原画 — 幸运之门·海之歌召唤活动',
  ...
  },
  {
    ...
    summaryEn: 'The Canyon Peak super zone on the Chinese LoL server rewards the top 2000 LP players in the 2026 Split 2 with Headhunter Akali (Pearl) prestige chroma, plus an exclusive icon and emoji. Distribution begins September 11, 2026; the chroma will also appear in future events.',
    summaryZh: '峡谷之巅 2026 第二赛段结算奖励发放：胜点前 2000 名召唤师可领取「铁血女忍 阿卡丽 斩魂粉樱」臻彩、专属图标和表情。2026 年 9 月 11 日起陆续发放，这款臻彩后续也会通过其他运营活动获取。',
    publishedAt: '2026-09-11',
    readingMinutes: 4,
    coverUrl: 'https://img.chromaart.lol/chromas/20ae2d84-67d5-485f-a8a7-3bfb8310a2bf/site3.jpg',
    coverAltEn: 'Headhunter Akali (Pearl) prestige chroma splash art — Canyon Peak 2026 Split 2 reward',
    coverAltZh: '铁血女忍 阿卡丽 斩魂粉樱臻彩原画 — 峡谷之巅 2026 第二赛段奖励',
  ...
  },
  {
    ...
    readingMinutes: 12,
    coverUrl: '/img/blog/brilliant-prestige-chroma-summoning-guide-cover-v2.png',
    coverAltEn: 'A confectionery fantasy summoning scene with a featured reward panel and chroma gems',
    coverAltZh: '璀璨臻彩召唤指南封面：点心幻想场景、特色奖励面板与臻彩宝石',
    sourceUrl: 'https://lol.qq.com/act/a202609047293tendraws35/index.html',
    adEligible: true,
    category: 'guide',
  },
