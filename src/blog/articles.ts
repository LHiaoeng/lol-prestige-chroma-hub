...
export const blogArticles: readonly BlogArticle[] = [
  ...
  },
  {
    ...
    summaryEn: 'The July 29, 2026 announcement previews three Petals of Spring prestige chromas in Lucky Gate: Lillia, Katarina, and Yasuo, all named Emerald in the archive.',
    summaryZh: '2026 年 7 月 29 日公告预告：幸运之门·召唤将带来踏雪寻梅莉莉娅、卡特琳娜和亚索三款“独步早春”臻彩。',
